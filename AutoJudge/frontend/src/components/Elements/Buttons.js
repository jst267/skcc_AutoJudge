...
class Buttons extends Component {
    ...
    render() {
        ...
        const BUTTONS = ['none', 'primary', 'success', 'info', 'warning', 'danger']
        ...
        return (
            <ContentWrapper>
                ...
                <CardWithHeader header="Button Labeled">
                    ...
                    <Button color="none" className="btn-labeled">
                ...
                <CardWithHeader header="Outline Buttons">
                    <Button outline className="mb-1" color="none" type="button">none</Button>
                ...
                <Row>
                    <Col md={ 6 }>
                        ...
                        <CardWithHeader header="Button Pills">
                            ...
                            <div>
                                <Button color="none" className="btn-pill-left">none</Button>
                            ...
                            <div>
                                <Button color="none" className="btn-pill-right">none</Button>
                    ...
                    <Col md={ 6 }>
                        ...
                        <CardWithHeader header="Button Oval">
                            <Button color="none" className="btn-oval">none</Button>
                        ...
                        <CardWithHeader header="Button Square">
                            <Button color="none" className="btn-square">none</Button>
